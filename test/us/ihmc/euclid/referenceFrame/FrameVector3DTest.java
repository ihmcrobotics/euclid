...
public class FrameVector3DTest extends FrameTuple3DTest<FrameVector3D, Vector3D>
{
   ...
   public void testCrosses() //Brett
   {
      ...
      for (int i = 0; i < 100; i++) //compare against Vector3d.cross()
      {
         ...
         Vector3D staticResult = EuclidCoreRandomTools.generateRandomVector3D(random);
   ...
   public void testLimitLength() throws Exception
   {
      ...
      for (int i = 0; i < 100; i++)
      {
         double maximumLength = EuclidCoreRandomTools.generateRandomDouble(random, 0.0, 10.0);
         ...
         double bigLength = EuclidCoreRandomTools.generateRandomDouble(random, 1.0, 10.0) * maximumLength;
