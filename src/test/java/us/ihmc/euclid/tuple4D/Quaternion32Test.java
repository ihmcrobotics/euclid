...
public class Quaternion32Test extends QuaternionBasicsTest<Quaternion32>
{
   ...
   public void testQuaternion32()
   {
      ...
      { // Test Quaternion32()
         expected.setToZero();
         EuclidCoreTestTools.assertEquals(quaternion, expected, (double) EPS);
      }
      ...
      { // Test Quaternion32(QuaternionBasics other)
         ...
         EuclidCoreTestTools.assertEquals(quaternion, quaternion2, (double) EPS);
         EuclidCoreTestTools.assertEquals(quaternion, quaternionCopy, (double) EPS);
      }
      ...
      { // Test Quaternion32(float[] quaternionArray)
         ...
         EuclidCoreTestTools.assertEquals(expected, quaternion, (double) EPS);
      }
