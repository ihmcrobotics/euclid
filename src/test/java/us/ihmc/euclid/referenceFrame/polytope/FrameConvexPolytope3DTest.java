...
public class FrameConvexPolytope3DTest extends FrameShapeSetupTest
{
   ...
   public void testReferenceFrameChecks() throws Throwable
   {
      ...
      EuclidFrameAPITester.assertMethodsOfReferenceFrameHolderCheckReferenceFrame(EuclidFrameShapeRandomTools::nextFrameConvexPolytope3D,
                                                                                  methodFilter,
   ...
   public void testConsistencyWithBox3D()
   {
      ...
      methodFilter = methodFilter.and(m -> Stream.of(m.getParameterTypes()).noneMatch(type -> Vertex3DReadOnly.class.isAssignableFrom(type)));
      EuclidFrameAPITester.assertFrameMethodsOfFrameHolderPreserveFunctionality((frame,
                                                                                 convexPolytope) -> new FrameConvexPolytope3D(frame,
