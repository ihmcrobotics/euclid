...
public class FrameLineSegment2DTest extends FrameLineSegment2DReadOnlyTest<FrameLineSegment2D>
{
   ...
   public void testConsistencyWithLineSegment2D()
   {
      ...
      EuclidFrameAPITester.GenericTypeBuilder framelessTypeBuilder = EuclidGeometryRandomTools::nextLineSegment2D;
   ...
   public void testOverloading() throws Exception
   {
      ...
      EuclidFrameAPITester.assertOverloadingWithFrameObjects(FrameLineSegment2D.class, LineSegment2D.class, true, 1, framelessMethodsToIgnore);
   }
