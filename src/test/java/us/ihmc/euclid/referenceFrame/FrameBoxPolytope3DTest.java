   ...
   public void testAgainstConvexPolytope()
   {
      ...
      for (int i = 0; i < ITERATIONS; i++)
      {
         ...
         for (FrameFace3DReadOnly boxFace : boxPolytope3D.getFaces())
         {
            ...
            EuclidFrameTestTools.assertGeometricallyEquals(boxFace.getCentroid(), boxFace.getCentroid(), EPSILON);
            EuclidFrameTestTools.assertGeometricallyEquals(boxFace.getNormal(), boxFace.getNormal(), EPSILON);
