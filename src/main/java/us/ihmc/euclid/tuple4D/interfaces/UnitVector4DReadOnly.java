...
/**
 * Read-only interface for 4 dimensional unit-length vector.
 * <p>
 ...
 */
public interface UnitVector4DReadOnly extends Vector4DReadOnly
{
   /**
    * {@inheritDoc}
    * <p>
    ...
    * {@inheritDoc}
    * <p>
    * Before returning the value of the d-component of this unit vector, it is first normalized if
    * marked as dirty.
    * </p>
    */
   @Override
   ...
   /**
    * Unsafe getter to access the internal value for the s-component of this unit vector while
    * by-passing the normalization step.
    * <p>
    * This getter is destined to internal API and advanced users only.
    * </p>
    *
    * @return the unnormalized value for the s-component of this unit vector.
    */
   double getRawS();
