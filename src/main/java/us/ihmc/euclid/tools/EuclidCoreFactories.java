...
public class EuclidCoreFactories
{
    ...
    */
   public static Vector2DBasics newUnitaryVector2D()
   {
      return newUnitaryVector2D(1.0, 0.0);
   }
    ...
    * @return the new unitary vector.
    */
   public static Vector2DBasics newUnitaryVector2D(Vector2DReadOnly initialValue)
   {
      return newUnitaryVector2D(initialValue.getX(), initialValue.getY());
   }
    ...
    * @return the new unitary vector.
    */
   public static Vector2DBasics newUnitaryVector2D(double initialX, double initialY)
   {
      return new Vector2DBasics()
      {
         ...
         {
            if (object instanceof Vector2DReadOnly)
               return Vector2DBasics.super.equals((Vector2DReadOnly) object);
            else
               return false;
         }
    ...
    * @return the new unitary vector.
    */
   public static Vector3DBasics newUnitaryVector3D()
   {
      return newUnitaryVector3D(Axis.X);
   }
    ...
    * @return the new unitary vector.
    */
   public static Vector3DBasics newUnitaryVector3D(Vector3DReadOnly initialValue)
   {
      return newUnitaryVector3D(initialValue.getX(), initialValue.getY(), initialValue.getZ());
   }
    ...
    * @return the new unitary vector.
    */
   public static Vector3DBasics newUnitaryVector3D(double initialX, double initialY, double initialZ)
   {
      return new Vector3DBasics()
      {
         ...
         {
            if (object instanceof Vector3DReadOnly)
               return Vector3DBasics.super.equals((Vector3DReadOnly) object);
            else
               return false;
         }
