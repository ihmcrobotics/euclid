...
public interface FixedFramePose3DBasics extends FramePose3DReadOnly, Pose3DBasics
{
    ...
    *
    * @param orientation the quaternion to set the orientation part of this frame pose. Not
    *           modified.
    * @throws ReferenceFrameMismatchException if {@code this} and {@code orientation} are not
    *            expressed in the same reference frame.
    */
    ...
    * @throws ReferenceFrameMismatchException if {@code this} and {@code rotation} are not expressed
    *            in the same reference frame.
    */
