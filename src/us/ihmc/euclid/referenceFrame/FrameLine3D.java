 ...
 * {@code FrameLine3D}. This allows, for instance, to enforce, at runtime, that operations on
...
public class FrameLine3D implements FrameLine3DBasics, GeometryObject<FrameLine3D>
{
    ...
    * frame to {@code ReferenceFrame.getWorldFrame()}.
    * 
    * @param line3DReadOnly the line used to initialize the point and direction of this. Not
    *           modified.
    */
