...
public class EuclidGeometryPolygonTools
{
   ...
   /**
    * Tests if the polygon defined by the given {@code vertices} is convex at the vertex defined by the
    * given {@code vertexIndex}.
    * <p>
    * Edge cases:
    * <ul>
    ...
    * <a href="https://en.wikipedia.org/wiki/Gift_wrapping_algorithm">Gift wrapping algorithm</a> for
    * computing the convex hull 2D of a set of points.
    * <p>
    * The given list {@code vertices} is reordered such that the vertices of the clockwise convex hull
    * are positioned first. The method returns the number of vertices that compose the convex hull.
    * </p>
    *
    ...
    * </p>
    *
    * @param vertices         the 2D point cloud from which the convex hull is to be computed.
    *                         Modified.
    ...
    * convex hull 2D of a set of points.
    * <p>
    * The given list {@code vertices} is reordered such that the vertices of the clockwise convex hull
    * are positioned first. The method returns the number of vertices that compose the convex hull.
    * </p>
   ...
   public static int inPlaceGrahamScanConvexHull2D(List<? extends Point2DReadOnly> vertices, int numberOfVertices)
   {
      ...
      while (currentIndex < numberOfVertices)
      {
         ...
         { // Not convex: remove the current vertex.
            ...
            /*
             * Need verify the previous vertex since the current has been updated but always knowing that the
             * first vertex has to be part of the hull.
             */
    ...
    * @param numberOfVertices the number of vertices that belong to the convex polygon.
    * @param clockwiseOrdered whether the vertices are clockwise or counter-clockwise ordered.
    * @param normalToPack     the vector that is orthogonal to the edge and points toward the outside
    ...
    * @param convexPolygon2D          the list containing in [0, {@code numberOfVertices}[ the vertices
    *                                 of the convex polygon. Not modified.
    * @param numberOfVertices         the number of vertices that belong to the convex polygon.
    * @param clockwiseOrdered         whether the vertices are clockwise or counter-clockwise ordered.
                                                                 ...
                                                                 Point2DBasics secondIntersectionToPack)
   {
      ...
      return intersectionBetweenLine2DAndConvexPolygon2D(pointOnLineX,
                                                         pointOnLineY,
                                                         lineDirectionX,
                                                         lineDirectionY,
                                                         convexPolygon2D,
                                                                 ...
                                                                 Point2DBasics secondIntersectionToPack)
   {
      ...
      int firstEdgeIndex = nextEdgeIndexIntersectingWithLine2D(-1,
                                                               pointOnLineX,
                                                               pointOnLineY,
                                                               lineDirectionX,
                                                               lineDirectionY,
      ...
      boolean success = intersectionBetweenLine2DAndLineSegment2D(pointOnLineX,
                                                                  pointOnLineY,
                                                                  lineDirectionX,
                                                                  lineDirectionY,
                                                                  edgeStart.getX(),
      ...
      int secondEdgeIndex = nextEdgeIndexIntersectingWithLine2D(firstEdgeIndex,
                                                                pointOnLineX,
                                                                pointOnLineY,
                                                                lineDirectionX,
                                                                lineDirectionY,
      ...
      success = intersectionBetweenLine2DAndLineSegment2D(pointOnLineX,
                                                          pointOnLineY,
                                                          lineDirectionX,
                                                          lineDirectionY,
                                                          edgeStart.getX(),
      ...
      secondEdgeIndex = nextEdgeIndexIntersectingWithLine2D(secondEdgeIndex,
                                                            pointOnLineX,
                                                            pointOnLineY,
                                                            lineDirectionX,
                                                            lineDirectionY,
    ...
    * @param clockwiseOrdered         whether the vertices are clockwise or counter-clockwise ordered.
    * @param firstIntersectionToPack  point in which the coordinates of the first intersection between
    *                                 the line segment and the convex polygon. Can be {@code null}.
    *                                 Modified.
    * @param secondIntersectionToPack point in which the coordinates of the second intersection between
    *                                 the line segment and the convex polygon. Can be {@code null}.
    *                                 Modified.
                                                                        ...
                                                                        Point2DBasics secondIntersectionToPack)
   {
      ...
      for (int edgeIndex = 0; edgeIndex < numberOfVertices; edgeIndex++)
      {
         ...
         double lambda = percentageOfIntersectionBetweenTwoLine2Ds(edgeStart.getX(),
                                                                   edgeStart.getY(),
                                                                   edgeVectorX,
                                                                   edgeVectorY,
    ...
    * <li>This methods assumes that the ray does not intersect with the polygon. Such scenario should
    * be handled with
                                                           ...
                                                           Point2DBasics closestPointToPack)
   {
      ...
      boolean areRayAndNextEdgeParallel = areVector2DsParallel(nextEdgeDirectionX,
                                                               nextEdgeDirectionY,
                                                               rayDirection.getX(),
                                                               rayDirection.getY(),
                                                               ONE_TEN_MILLIONTH);
      ...
      boolean areRayAndPreviousEdgeParallel = areVector2DsParallel(previousEdgeDirectionX,
                                                                   previousEdgeDirectionY,
                                                                   rayDirection.getX(),
                                                                   rayDirection.getY(),
                                                                   ONE_TEN_MILLIONTH);
    ...
    * observer is different from the polygon's vertex, or returns {@code null} if the observer is equal
    * to the polygon's vertex.
    * </ul>
    * </p>
    *
    * @param observer         the coordinates of the observer. Not modified.
    ...
    * Edge cases:
    * <ul>
    * <li>If {@code previousEdgeIndex == -2}, this method automatically fails and returns {@code -2}.
    * <li>If the polygon has less than 2 vertices, this method fails and returns {@code -2}.
    * <li>If the line and an edge of the polygon are collinear and the polygon has exactly 2 vertices,
    * this method fails and returns {@code -2}.
    ...
    * </p>
    *
    * @param previousEdgeIndex refers to the index of the previously found edge intersecting with the
    *                          line. To find the first intersecting edge, it should be set to
    *                          {@code -1}.
    * @param pointOnLine       a point located on the line. Not modified.
    * @param lineDirection     the direction of the line. Not modified.
    * @param convexPolygon2D   the list containing in [0, {@code numberOfVertices}[ the vertices of the
    ...
    * </p>
    * <p>
    * Then the vertices are sorted in increasing order of the angle they and the reference P make with
    * the y-axis.
    * </p>
    * <p>
    * The <a href="https://en.wikipedia.org/wiki/Quicksort#Choice_of_pivot">Quicksort algorithm</a> is
    * adapted to the Graham scan application to prevent garbage generation.
    * </p>
    *
   ...
   /**
    * Moves the element located at {@code indexOfElementToShift} to {@code listSize - 1} and shifts all
    * the elements located in [{@code indexToRemove + 1}; {@code listSize - 1}] by {@code -1}.
    *
   ...
   /**
    * Finds the index of the vertex with the lowest x-coordinate. If the lowest x-coordinate exists in
    * more than one vertex in the list, the vertex with the highest y-coordinate out of the candidates
    * is chosen.
    *
    ...
    * @param xBound           the search criterion for the x-coordinate, for instance {@link Bound#MAX}
    *                         will result in searching the vertex with the highest x value.
    * @param yBound           the search criterion for the Y-coordinate, for instance {@link Bound#MIN}
    *                         will result in searching the vertex with the lowest y value.
