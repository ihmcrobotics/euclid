 ...
 * <p>
 * While the main use-case of a {@code Shape3DPoseBasics} is to describe the pose of a shape 3D, it
 * is also used to represent the transform from the shape local coordinate system to the world
